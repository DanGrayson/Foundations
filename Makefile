...
OTHERFLAGS += -noinit -indices-matter -w '-notation-overridden,-local-declaration,+uniform-inheritance,-deprecated-option'
ifeq ($(VERBOSE),yes)
OTHERFLAGS += -verbose
endif
...
BUILD_OPTIONS += READABLE_ML4=yes KEEP_ML4_PREPROCESSED=true
endif
ifeq ($(BUILD_COQIDE),yes)
