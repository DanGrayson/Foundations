...
Proof.
  intros. apply impred; intro g. apply impred; intro x.
  apply setproperty.
Defined.
...
Proof.
  intros. apply isinclpr1; intro f. apply is_equivariant_isaprop.
Defined.
...
Proof.
  ...
  exact (eqweqmap (maponpaths is_equivariant (pr1_eqweqmap (maponpaths pr1hSet p)))).
Defined.
